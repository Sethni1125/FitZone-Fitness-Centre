...
$username = "root";
$password = "";
$database = "fitzone1"; // Change this to your actual DB name
...
<head>
    <title>FitZone - Vinyasa Flow Yoga Booking</title>
        ...
        <div class="mockup">
            <div class="mockup-header">
                ...
                <div class="nav">
                    ...
                    <a href="../front-end/class.html" class="nav-item active">Classes</a>
            ...
            <div class="class-details">
                <div class="instructor-info">
                    ...
                    <div>
                        ...
                        <p>Experience a dynamic and fluid yoga practice that synchronizes breath with movement. This Vinyasa Flow class will help you build strength, improve flexibility, and find inner peace through a series of carefully crafted sequences.</p>
                    </div>
                </div>
                ...
                <div>
                    <h4>Class Details</h4>
                    <ul>
                        <li><strong>Instructors:</strong> Ms. Elena Rodriguez, Ms. Sophia Chen</li>
                        <li><strong>Duration:</strong> 75 minutes</li>
                        <li><strong>Difficulty Level:</strong> All Levels (Modifications Provided)</li>
                        <li><strong>Equipment Needed:</strong> Yoga mat, water bottle, optional yoga block</li>
                    </ul>
                </div>
            </div>
