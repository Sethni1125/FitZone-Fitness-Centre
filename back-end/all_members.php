...
<body>
    <div class="container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr data-status="<?= $status ?>" data-membership="<?= $membershipClass ?>">
                        ...
                        <td class="actions">
                            <button class="edit-btn" onclick="editMember(<?= $row['id'] ?>)"><i class="fas fa-edit"></i></button>
        ...
        <a href="../front-end/Admin Home.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
