...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Set recipient email
    $to = "fitzonefitness@gmail.com"; // Change this to your desired recipient
...
<body>
        ...
        <div class="mockup">
            <div class="mockup-header">
                ...
                <div class="nav">
                    ...
                    <a href="../front-end/Class.php" class="nav-item">Classes</a>
                    <a href="../front-end/Membership.html" class="nav-item">Membership</a>
                    <a href="../front-end/Contact Us.html" class="nav-item active">Contact Us</a>
            ...
            <div class="hero">
                <h2>Get in Touch</h2>
                <p>Have questions about our services or want to schedule a tour? Reach out to us and our team will get back to you as soon as possible.</p>
            </div>
            ...
            <div class="map-container">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7829620!2d79.8548767!3d6.8991674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae259621dbd34e7%3A0x6f29b40054b6b15a!2sQueen&#39;s%20Rd%2C%20Colombo!5e0!3m2!1sen!2slk!4v1709128456789!5m2!1sen!2slk" 
                    width="100%" 
                    height="100%" 
                    style="border:0;" 
                    allowfullscreen="" 
            ...
            <div class="grid-2">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-info-item">
                        ...
                        <div>
                            <h4>Our Location</h4>
                            <p>123 Queen Street, Colombo 3</p>
                        </div>
                    </div>
                    <div class="contact-info-item">
                        <div class="contact-info-icon">
                    ...
                    <div class="contact-info-item">
                        ...
                        <div>
                            <h4>Email Address</h4>
                            <p>fitzonefitness@gmail.com</p>
                            <p>infofitzon@gmail.com</p>
                        </div>
                    </div>
                    <div class="contact-info-item">
                        <div class="contact-info-icon">
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="../front-end/class.html">Classes</a></li>
        ...
        <div class="footer-bottom">
            <p>&copy; 2023 FitZone Fitness Center. All rights reserved.</p>
        </div>
    </footer>
    ...
    <script>
            ...
            const tiltableElements = document.querySelectorAll('.feature, .contact-form, .contact-info');
            ...
            document.addEventListener('mousemove', function(e) {
                tiltableElements.forEach(element => {
                    ...
                    // Apply the rotation only if mouse is over or near the element
                    if (
