...
<head>
    <title>FitZone - Advanced Strength Training Booking</title>
            ...
            <div class="class-details">
                <div class="instructor-info">
                    ...
                    <div>
                        ...
                        <p>Elevate your fitness with our high-intensity cardio program designed to boost endurance, burn calories, and improve cardiovascular health. This dynamic class combines interval training, plyometrics, and heart-pumping exercises to help you achieve your fitness goals.</p>
                    </div>
                </div>
                ...
                <div>
                    <h4>Class Details</h4>
                    <ul>
                        <li><strong>Instructors:</strong> Ms. Elena Rodriguez, Mr. Jayantha Perera</li>
                        <li><strong>Duration:</strong> 45 minutes</li>
                        <li><strong>Difficulty Level:</strong> Intermediate to Advanced</li>
                        <li><strong>Equipment Needed:</strong> Athletic wear, running shoes, water bottle, towel</li>
                    </ul>
                </div>
            </div>
