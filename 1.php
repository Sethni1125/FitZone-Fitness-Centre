...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $class_name = "Advanced Strength Training";
...
<head>
    <title>FitZone - Cardio Workouts Booking</title>
            ...
            <div class="class-details">
                <div class="instructor-info">
                    ...
                    <div>
                        ...
                        <p>Take your strength to the next level with compound movements and progressive overload techniques. This advanced class is designed for fitness enthusiasts looking to maximize muscle growth, increase strength, and improve overall body composition.</p>
                    </div>
                </div>
                ...
                <div>
                    <h4>Class Details</h4>
                    <ul>
                        <li><strong>Instructors:</strong> Mr. Anuja Rajakaruna, Mr. Yuvindu Mihijaya</li>
                        <li><strong>Duration:</strong> 60 minutes</li>
                        <li><strong>Difficulty Level:</strong> Advanced</li>
                        <li><strong>Equipment Needed:</strong> Gym attire, water bottle, towel</li>
                    </ul>
                </div>
            </div>
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="class_time" id="classTime" required>
                        ...
                        <option value="10am">12:00 PM (Mon, Wed, Fri)</option>
                        <option value="2pm">2:00 PM (Mon, Wed, Fri)</option>
                        <option value="5Pm">5:00 PM (Mon, Wed, Fri)</option>
                        <option value="6am">6:00 AM (Sat, Sun)</option>
                    </select>
                </div>
                <div class="form-group">
