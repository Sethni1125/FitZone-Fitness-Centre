...
<head>
    <title>FitZone - HIIT Circuit Training Booking</title>
            ...
            <div class="class-details">
                <div class="instructor-info">
                    ...
                    <div>
                        ...
                        <p>Elevate your fitness with our high-intensity interval training (HIIT) circuit. This dynamic class combines cardio and strength exercises to boost metabolism, improve endurance, and burn maximum calories in minimal time.</p>
                    </div>
                </div>
                ...
                <div>
                    <h4>Class Details</h4>
                    <ul>
                        <li><strong>Instructors:</strong> Ms. Malithi Wijesinghe, Mr. Rohan Perera</li>
                        <li><strong>Duration:</strong> 45 minutes</li>
                        <li><strong>Difficulty Level:</strong> Intermediate to Advanced</li>
                        <li><strong>Equipment Needed:</strong> Athletic wear, water bottle, towel, light dumbbells (optional)</li>
                    </ul>
                </div>
            </div>
