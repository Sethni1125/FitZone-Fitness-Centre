...
<body>
    ...
    <div class="container">
        ...
        <div class="button-group">
            <a href="../back-end/all_member.php" class="neumorphic-button primary-button">All Members</a>
            <a href="../front-end/Trainers1.php" class="neumorphic-button primary-button">All Instructors</a>
            <a href="../front-end/l.php" class="neumorphic-button primary-button" onclick="confirmLogout()">Log Out</a>
        </div>
    </div>
    ...
    function confirmLogout() {
        if (confirm("Are you sure you want to log out?")) {
            window.location.href = "../front-end/l.php";
        }
    }
</script>
</body>
