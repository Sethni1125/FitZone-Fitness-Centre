...
<div class="theme-toggle" id="themeToggle">
    ...
    <div class="container">
        ...
        <div class="hero">
                ...
                <a href="process_contribution2.php" class="btn btn-secondary">Client Contribute</a>
            </div>
    ...
    <div class="container">
        <div class="content">
        <form action="process_contribution2.php" method="post" enctype="multipart/form-data" class="contribution-form">
